...
<html lang="en">
  ...
  <head>
    ...
    <meta name="description" content="Steel Blog">
    <meta name="author" content="Steel Ricciotti">
  ...
  <body>
    ...
    <footer class="py-5 bg-dark">
      <div class="container">
        <p class="m-0 text-center text-white">Copyright &copy; Steel Ricciotti 2019</p>
      </div>
      <!-- /.container -->
    </footer>
